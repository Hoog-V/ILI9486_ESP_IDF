...
DRAM_ATTR static const lcd_init_cmd_t ili_init_cmds[]={
    ...
    {0xC0, {0x1900, 0x1A00}, 4},
    {0xC1, {0x4500, 0x0000}, 4},
    {0xC2, {0x3300},2},
    {0xC5, {0x0000, 0x2800},4},
    {0xB1, {0xA000, 0x1100},4},
    {0xB4, {0x0200}, 2},
    {0xB6, {0x0000, 0x4200, 0x3B00},6},
    /* Positive gamma correction */
    {0xE0, {0x1F00, 0x2500, 0x2200, 0x0B00, 0x0600, 0x0A00, 0x4E00, 0xC600, 0x3900, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000}, 30},
    /* Negative gamma correction */
    {0XE1, {0x1F00, 0x3F00, 0x3F00, 0x0F00, 0x1F00, 0x0F00, 0x4600, 0x4900, 0x3100, 0x0500, 0x0900, 0x0300, 0x1C00, 0x1A00, 0x0000}, 30},
    /* Pixel format, 16bits/pixel for RGB/MCU interface */
    {0x3A, {0x5500}, 2},
    {0xB6, {0x0000, 0x2200},4},
    //{0x20, {0}, 0x80},
    {0x36, {0x0800}, 2},
    {0x11, {0}, 0x80},
    /* Display on */
